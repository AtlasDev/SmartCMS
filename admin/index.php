...
<html>
	...
	<body class="bg">
		<div class="body container-fluid row">
			<aside class="col-md-3 col-lg-2 col-sm-4">
                <div class="user">
                    <div class="user-top">
                        <h2>Hi, AtlasDev</h2>
                        <hr />
                        <b>Name: </b>Dany Sluijk<br />
                        <b>Rank: </b>Administrator<br />
                        <b>Reputation: </b>301 points<br />
                        <b>Unread messages: </b>361 pm&#39;s<br />
                    </div>
                    <div class="user-bottom">
                        <a href="#" class="col-md-6">PROFILE</a>
                        <a href="#" class="col-md-6">LOGOUT</a>
                    </div>
                </div>
				<ul class="menu menu-pos-left menu-anim-scale menu-response-to-switcher">
					<li>
					...
					<li aria-haspopup="true">
						<a href><i class="fa fa-thumb-tack"></i>Posts</a>
						<div class="grid-container3">
							<ul>
								<li>
									<a href><i class="fa fa-list"></i>All posts</a>
									<div class="grid-container3">
										<ul>
								...
								<li><a href="#"><i class="fa fa-gear"></i>Categories</a></li>
					...
					<li aria-haspopup="true">
						...
						<div class="grid-container3">
							<ul>
								<li><a href="#"><i class="fa fa-list"></i>All pages</a></li>
								<li><a href="#"><i class="fa fa-plus"></i>Add new</a></li>
							</ul>
						</div>
					</li>
					...
					<li aria-haspopup="true">
						<a href><i class="fa fa-bolt"></i>Plugins</a>
						<div class="grid-container3">
							<ul>
								<li><a href="#"><i class="fa fa-plus"></i>Add new</a></li>
								<li><a href="#"><i class="fa fa-edit"></i>Editor</a></li>
					...
					<li aria-haspopup="true">
						...
						<div class="grid-container3">
							<ul>
								<li><a href="#"><i class="fa fa-list"></i>All users</a></li>
								<li><a href="#"><i class="fa fa-plus"></i>Add new</a></li>
